...
const VideoBackground = (movieId) => {
    ...
    const trailerAutoplay = trailerKey?.key + "?autoplay=1&loop=1&mute=1&controls=0&disablekb=1&playlist=" + trailerKey?.key;
    ...
    return (
        <div className="w-screen h-fit pb-[180px]">
            <iframe
                ...
                src={`${TRAILER_LINK}${trailerAutoplay}&vq=hd1080`}
